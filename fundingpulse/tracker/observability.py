...
class DomainEvents(StrEnum):
    ...
    HISTORY_BACKFILL_COMPLETED = "history_backfill_completed"
    HISTORY_BACKFILL_FAILED = "history_backfill_failed"
    HISTORY_BACKFILL_CONTRACT_FAILED = "history_backfill_contract_failed"
